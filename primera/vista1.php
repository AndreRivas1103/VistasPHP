...
<html lang="en">
    <head>
        ...
        <title>Permiso Estudiantes</title>
    </head>
    <nav>
        <a href="../index.php">Inicio</a>
    </nav>
    <body class="body1">
        <h1 class="title1">Permiso Estudiantes</h1>
        <p class="relleno">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In mollis
            ...
            <br>
        <center><h2 class="zzz3">Consulta</h2></center>
        <form name="form1" action="resultadoConsulta1.php" method="post">
            <center><table >
                <tr>
                    <td class="zzz2">Ingrese el nombre del estudiante:</td>
                    <td><input class="zzz" type="text" name="nombre" size="10" placeholder="Nombre" required></td>
                </tr>
